...
for a in (1.0,0.95,0.9,0.85,0.8,0.7,0.6,0.5,0.3,0.0):
    ...
    d=(t(obj.data.root_pos_w)[:,:2]-spawn[:,:2]).norm(dim=-1); tip=_tip_handle_distance(env,SceneEntityCfg("object"),SceneEntityCfg("ee_frame"),wc)
