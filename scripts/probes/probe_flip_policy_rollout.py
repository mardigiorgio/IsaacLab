...
for e in [n for n in vars(cfg.events) if n.startswith("reset_arm_") and n.endswith("_bank")]: getattr(cfg.events,e).params["bank_fraction"]=0.0  # EVERY bank off: bank none = true home
