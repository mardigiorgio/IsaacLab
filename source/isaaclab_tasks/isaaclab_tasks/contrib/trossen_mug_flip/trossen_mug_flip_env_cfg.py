...
class FlipActionsCfg:
    """Slide's action set with the plate's discovery-wide arm scale: the flip
    is a ~180-degree wrist reorientation, which scale 0.25 cannot express
    (0.25 x clip 6 = 1.5 rad of commandable travel)."""
