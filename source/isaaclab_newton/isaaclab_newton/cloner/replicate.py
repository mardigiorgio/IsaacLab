...
class NewtonReplicateContext:
    ...
    def __init__(
        ...
        *,
        ...
        # The mesh-simplification exclusion patterns always come from the active cfg (they
        # have no constructor override), so resolve the cfg once for them and for the two
        # ``None`` defaults below.
        ...
        self.simplify_meshes_exclude = list(cfg.simplify_meshes_exclude) if is_newton_cfg else []
